...
const backbuffer_js_1 = require("./backbuffer.js");
const constants_js_1 = require("./constants.js");
const copy_pass_js_1 = require("./copy-pass.js");
const dom_to_canvas_js_1 = __importDefault(require("./dom-to-canvas.js"));
const gif_js_1 = __importDefault(require("./gif.js"));
const gl_rect_js_1 = require("./gl-rect.js");
const post_effect_pass_js_1 = require("./post-effect-pass.js");
...
class VFXPlayer {
    constructor(opts, canvas) {
        ...
        _VFXPlayer_viewport.set(this, (0, rect_js_1.createRect)(0));
        /** Actual viewport without padding */
        _VFXPlayer_viewportInner.set(this, (0, rect_js_1.createRect)(0));
        ...
        // Setup copyScene
        __classPrivateFieldSet(this, _VFXPlayer_copyPass, new copy_pass_js_1.CopyPass(), "f");
        ...
        if (opts.postEffect) {
            ...
            __classPrivateFieldSet(this, _VFXPlayer_postEffectPass, new post_effect_pass_js_1.PostEffectPass(postEffectShader, opts.postEffect.uniforms, opts.postEffect.backbuffer), "f");
    ...
    addElement(element_1) {
        return __awaiter(this, arguments, void 0, function* (element, opts = {}) {
            ...
            const rect = (0, rect_js_1.toRect)(domRect);
            const [isFullScreen, overflow] = parseOverflowOpts(opts.overflow);
            const rectWithOverflow = (0, rect_js_1.growRect)(rect, overflow);
            ...
            if (opts.backbuffer) {
                backbuffer = (() => {
                    ...
                    const bh = (rectWithOverflow.bottom - rectWithOverflow.top) *
                        __classPrivateFieldGet(this, _VFXPlayer_pixelRatio, "f");
                    return new backbuffer_js_1.Backbuffer(bw, bh, __classPrivateFieldGet(this, _VFXPlayer_pixelRatio, "f"));
                })();
            ...
            const vertexShader = glslVersion === "100"
                ? constants_js_1.DEFAULT_VERTEX_SHADER_100
                : constants_js_1.DEFAULT_VERTEX_SHADER;
    ...
    render() {
        ...
        const viewportGlRect = (0, gl_rect_js_1.getGLRect)(0, 0, viewportWidth, viewportHeight);
        ...
        for (const e of __classPrivateFieldGet(this, _VFXPlayer_elements, "f")) {
            ...
            const glRect = (0, gl_rect_js_1.rectToGLRect)(rect, viewportHeight, __classPrivateFieldGet(this, _VFXPlayer_paddingX, "f"), __classPrivateFieldGet(this, _VFXPlayer_paddingY, "f"));
            const glRectWithOverflow = (0, gl_rect_js_1.rectToGLRect)(hit.rectWithOverflow, viewportHeight, __classPrivateFieldGet(this, _VFXPlayer_paddingX, "f"), __classPrivateFieldGet(this, _VFXPlayer_paddingY, "f"));
            if (e.backbuffer) {
                // Update backbuffer
...
_VFXPlayer_opts = new WeakMap(), _VFXPlayer_canvas = new WeakMap(), _VFXPlayer_renderer = new WeakMap(), _VFXPlayer_camera = new WeakMap(), _VFXPlayer_copyPass = new WeakMap(), _VFXPlayer_postEffectPass = new WeakMap(), _VFXPlayer_postEffectTarget = new WeakMap(), _VFXPlayer_postEffectUniformGenerators = new WeakMap(), _VFXPlayer_playRequest = new WeakMap(), _VFXPlayer_pixelRatio = new WeakMap(), _VFXPlayer_elements = new WeakMap(), _VFXPlayer_initTime = new WeakMap(), _VFXPlayer_textureLoader = new WeakMap(), _VFXPlayer_viewport = new WeakMap(), _VFXPlayer_viewportInner = new WeakMap(), _VFXPlayer_canvasSize = new WeakMap(), _VFXPlayer_paddingX = new WeakMap(), _VFXPlayer_paddingY = new WeakMap(), _VFXPlayer_mouseX = new WeakMap(), _VFXPlayer_mouseY = new WeakMap(), _VFXPlayer_isRenderingToCanvas = new WeakMap(), _VFXPlayer_scrollBarSize = new WeakMap(), _VFXPlayer_resize = new WeakMap(), _VFXPlayer_mousemove = new WeakMap(), _VFXPlayer_playLoop = new WeakMap(), _VFXPlayer_instances = new WeakSet(), _VFXPlayer_getScrollBarSize = function _VFXPlayer_getScrollBarSize() {
    ...
    if (widthWithPadding !== __classPrivateFieldGet(this, _VFXPlayer_canvasSize, "f")[0] ||
        ...
        __classPrivateFieldSet(this, _VFXPlayer_viewport, (0, rect_js_1.createRect)({
            top: -paddingY,
            left: -paddingX,
            right: widthWithPadding,
            bottom: heightWithPadding,
        }), "f");
        __classPrivateFieldSet(this, _VFXPlayer_viewportInner, (0, rect_js_1.createRect)({
            top: 0,
            left: 0,
            right: width,
            bottom: height,
    ...
    const rectWithOverflow = (0, rect_js_1.growRect)(rect, e.overflow);
    ...
    const viewportWithMargin = (0, rect_js_1.growRect)(__classPrivateFieldGet(this, _VFXPlayer_viewportInner, "f"), e.intersection.rootMargin);
    const intersection = (0, rect_js_1.getIntersection)(viewportWithMargin, rect);
...
function parseOverflowOpts(overflow) {
    if (overflow === true) {
        return [true, rect_js_1.MARGIN_ZERO];
    }
    if (overflow === undefined) {
        return [false, rect_js_1.MARGIN_ZERO];
    }
    return [false, (0, rect_js_1.createMargin)(overflow)];
}
function parseIntersectionOpts(intersectionOpts) {
    ...
    const rootMargin = (0, rect_js_1.createMargin)((_b = intersectionOpts === null || intersectionOpts === void 0 ? void 0 : intersectionOpts.rootMargin) !== null && _b !== void 0 ? _b : 0);
    return {
        threshold,
        rootMargin,
    };
