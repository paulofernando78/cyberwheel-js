...
const vfx_player_js_1 = require("./vfx-player.js");
...
class VFX {
    ...
    constructor(options = {}) {
        ...
        checkEnvironment();
        const opts = (0, types_js_1.getVFXOpts)(options);
        // Setup canvas
        ...
        __classPrivateFieldSet(this, _VFX_player, new vfx_player_js_1.VFXPlayer(opts, canvas), "f");
        if (opts.autoplay) {
    ...
    add(element, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            if (element instanceof HTMLImageElement) {
                yield __classPrivateFieldGet(this, _VFX_instances, "m", _VFX_addImage).call(this, element, opts);
            }
            else if (element instanceof HTMLVideoElement) {
                yield __classPrivateFieldGet(this, _VFX_instances, "m", _VFX_addVideo).call(this, element, opts);
            }
            else if (element instanceof HTMLCanvasElement) {
                yield __classPrivateFieldGet(this, _VFX_instances, "m", _VFX_addCanvas).call(this, element, opts);
            }
            else {
                yield __classPrivateFieldGet(this, _VFX_instances, "m", _VFX_addText).call(this, element, opts);
            }
        });
    }
    /**
