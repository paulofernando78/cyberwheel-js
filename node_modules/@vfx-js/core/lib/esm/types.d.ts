 ...
 * @internal
 */
export declare function getVFXOpts(opts: VFXOpts): VFXOptsInner;
/**
 ...
 */
export type VFXUniformValue = number | [number, number] | [number, number, number] | [number, number, number, number];
/**
 * @internal
 */
